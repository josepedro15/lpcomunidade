        ...
        <section className="relative min-h-screen flex items-center justify-center px-6" aria-labelledby="hero-heading">
          <div className="relative z-10 max-w-5xl mx-auto text-center animate-fade-in">
            ...
            <div className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
              <BlurText
                text="Empresários visionários já estão usando IA para vender mais, automatizar processos e multiplicar resultados."
                delay={30}
                animateBy="words"
                direction="bottom"
        ...
        <section className="py-24 px-6 bg-secondary/10 backdrop-blur-sm">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { icon: TrendingUp, text: "+5 anos usando IA para acelerar resultados em negócios reais" },
